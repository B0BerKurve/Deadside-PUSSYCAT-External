...
inline namespace BloodHunt
{
	...
	{
	public:
		const char* dwProcessName = "Deadside-Win64-Shipping.exe";
...
#define GameVars BloodHunt::Variables::Get()
	...
	public:
		...
		DWORD offset_u_world = 0x4b181b0; // IDA searching for Names: UWorldProxy GWorld
		DWORD offset_g_names = 0x4996140;
		DWORD offset_camera_manager = 0x2b8; // APlayerController->PlayerCameraManager
		DWORD offset_camera_cache = 0x1ae0; //APlayerCameraManager->CameraCachePrivate
		...
		DWORD offset_player_name = 0x248; //PlayerNickName
